...
<div id="board-container">
	<form 
		...
		<input type="hidden" class="form-control" name="no" id="no" value="${board.no}" required>
				...
				<div class="btn-group-toggle p-0 mb-3" data-toggle="buttons">
                  <label class="btn btn-outline-danger btn-block" title="${attach.originalFilename}삭제">
                    <input type="checkbox" id="delFile${vs.count}" name="delFile" value="${attach.no}"> 
                   	...
                   	<c:if test="${fn:length(attach.originalFilename) le 30 }">
	    ...
	    <textarea class="form-control" name="content" id="content" placeholder="내용" required>${board.content}</textarea>
		<br />
