...
public interface BoardDao {
	...
	@Insert("insert into attachment(no, board_no, original_filename, renamed_filename) values (seq_attachment_no.nextval, #{boardNo}, #{originalFilename}, #{renamedFilename})")
	...
	List<Attachment> selectListAttachment(int boardNo);
