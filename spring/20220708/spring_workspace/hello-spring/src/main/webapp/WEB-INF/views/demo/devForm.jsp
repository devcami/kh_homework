...
<div id="demo-container" 
	...
	<form id="devFrm" name="devFrm">
		...
		<div class="form-group row">
		  ...
		  <div class="col-sm-10">
		    <input type="number" class="form-control" id="career" name="career" required>
		  </div>
		</div>
		<div class="form-group row">
	...
	<div class="list-group">
	  ...
	  <button type="button" onclick="insertDev();" class="list-group-item list-group-item-action">Database등록</button>
	</div>
</div>
<script>
