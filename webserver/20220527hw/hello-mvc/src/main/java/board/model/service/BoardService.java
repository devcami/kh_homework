...
public class BoardService {
	...
	public BoardExt findByNo(int no) {
		Connection conn = getConnection();
		BoardExt board = boardDao.findByNo(conn, no); //board table DQL
		List<Attachment> attatchments = boardDao.findAttachmentByBoardNo(conn, no); //attachment table DQL
		List<BoardComment> comments = boardDao.findBoardCommentByBoardNo(conn, no);
		board.setAttachments(attatchments);
