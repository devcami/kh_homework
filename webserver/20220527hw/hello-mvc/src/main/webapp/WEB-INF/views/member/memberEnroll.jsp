...
<section id=enroll-container>
	<h2>회원 가입 정보 입력</h2>
	<form name="memberEnrollFrm" method="POST" action="">
		<table>
			<tr>
				<th>아이디<sup>*</sup></th>
				<td>
					<%-- _memberId : 로그인 폼이 헤더에 있기 때문에 memberId와 중복되기 때문에 언더바 사용해줘야 한다. --%>
					<input type="text" placeholder="4글자이상" name="memberId" id="_memberId" value="sinsa" required>
					<input type="button" value="중복검사" onclick="checkIdDuplicate();" />
					<input type="hidden" id="idValid" value="0"/>
					<%-- #idValid 0이면 중복검사 전, 1이면 중복검사 통과 --%>
			...
			<tr>
				<th>휴대폰<sup>*</sup></th>
				<td>	
					<input type="tel" placeholder="(-없이)01012345678" name="phone" id="phone" maxlength="11" value="01012344444" required><br>
				</td>
			</tr>
			<tr>
				<th>주소</th>
...
const checkIdDuplicate = () => {
	...
	frm.target = title; // 해당 popup에서 폼을 제출
